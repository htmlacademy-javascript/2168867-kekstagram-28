...
//принять три параметра: исходную строку, минимальную длину и строку с добавочными символами. вернуть — исходную строку, с указанными символами до заданной длины.Символы добавить в начало строки. Если исходная строка больше заданной длины, она не должна обрезаться. Если «добивка» слишком длинная, она обрезается с конца.
